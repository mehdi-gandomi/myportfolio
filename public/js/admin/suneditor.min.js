...
SUNEDITOR.defaultLang={toolbar:{font:"فونت",formats:"قالب بندی",fontSize:"اندازه متن",bold:"پررنگ",underline:"زیرخط",italic:"کج",strike:"خط از وسط",subscript:"Subscript",superscript:"Superscript",removeFormat:"پاک کردن قالب ها",fontColor:"رنگ فونت",hiliteColor:"رنگ پس زمینه",indent:"تورفتگی",outdent:"برون رفتگی",align:"تراز بندی",alignLeft:"چپ چین",alignRight:"راست چین",alignCenter:"وسط چین",justifyFull:"مرتب سازی کامل",list:"لیست",orderList:"لیست مرتب",unorderList:"لبست نامرتب",line:"خط",table:"جدول",
        link:"لینک",image:"عکس",video:"ویدیو",fullScreen:"تمام صفحه",showBlocks:"نشان دادن بلاک ها",codeView:"نمایش کد",undo:"برگشت",redo:"دوباره",preview:"پیش نمایش",print:"پرینت",tag_p:"پاراگراف",tag_div:"نرمال (DIV)",tag_h:"هدر"},dialogBox:{linkBox:{title:"اضافه کردن لینک",url:"آدرس برای لینک",text:"متن برای تمایش",newWindowCheck:"باز کردن در پنجره جدید"},imageBox:{title:"اضافه کردن عکس",file:"انتخاب از فایل ها",url:"آدرس عکس",caption:"اضافه کردن توضیحات عکس",altText:"متن جابگزین"},videoBox:{title:"اضافه کردن ویدیو",
            url:"Media embed URL, YouTube"},resize100:"تغییر اندازه 100%",resize75:"تغییر اندازه 75%",resize50:"تغییر اندازه 50%",resize25:"تغییر اندازه 25%",remove:"حذف",submitButton:"تایید",revertButton:"برگشت تنظیمات",proportion:"constrain proportions",width:"اندازه",height:"ارتفاع",basic:"ابتدایی",left:"چپ",right:"راست",center:"وسط"},editLink:{edit:"ویرایش",remove:"حذف"}};
